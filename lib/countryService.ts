...
export const fetchCountryByCode = async (countryCode: string): Promise<Country | undefined> => {
  try {
...
export const fetchStatesForCountry = async (countryCode: string): Promise<string[] | undefined> => {
  try {
...
export const fetchCitiesForCountryOrState = async (countryCode: string): Promise<string[] | undefined> => {
  try {
