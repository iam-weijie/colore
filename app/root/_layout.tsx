...
const Layout = () => {
  ...
  return (
    <Stack>
      ...
      <Stack.Screen name="new-post" options={{ headerShown: false, animation: 'slide_from_bottom', animationDuration: 300  }} />
      <Stack.Screen name="new-board" options={{ headerShown: false, animation: 'slide_from_bottom', animationDuration: 300  }} />
      ...
      <Stack.Screen name="new-personal-post" options={{ headerShown: false, animation: 'slide_from_bottom', animationDuration: 300 }} />
