          ...
          <View className="m-6 flex-row justify-between items-center w-full px-4">
            <Animated.View entering={FadeIn.duration(800)}>
              {username ? (
                ...
                <Text
                  className={`text-2xl bg-[#E7E5Eb] text-[#E7E5Eb] font-JakartaBold`}
                >
                  Personal Board
                </Text>
              )}
              {boardInfo ? (
                ...
                <View>
                  <Text className=" text-xs text-gray-600 text-left font-Jakarta"></Text>
                </View>
              )}
            ...
            {boardInfo && (
              <View className="flex-row gap-6 mr-7">
                ...
                <View className="flex-column items-start justify-center">
                  ...
                  <Text className="text-xs font-JakartaSemiBold">Members</Text>
                </View>
              </View>
            )}
          </View>
